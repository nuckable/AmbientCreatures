package com.flashoverride.ambientcreatures.items;
...
public class ItemCreaturePlacer extends ItemMonsterPlacer
{
    ...
    public ItemCreaturePlacer()
    {
        super();
    }
    
    public ItemCreaturePlacer(String parEntityToSpawnName, int parPrimaryColor, int parSecondaryColor)
    {
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
       if (!parWorld.isRemote) // never spawn entity on client side
        {
		    entityToSpawnNameFull = ModDetails.ModID+"."+entityToSpawnName;
...
//       }  
    ...
    public void setEntityToSpawnName(String parEntityToSpawnName)
    {
        ...
        entityToSpawnNameFull = ModDetails.ModID+"."+entityToSpawnName; // need to extend with name of mod
