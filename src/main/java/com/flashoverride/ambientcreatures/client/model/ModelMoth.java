  ...
  extends ModelBase
{
  ...
  public void render(Entity entity, float time, float swingSuppress, float p_78088_4_, float headAngleY, float headAngleX, float p_78088_7_)
  {
     ...
     setRotationAngles(time, swingSuppress, p_78088_4_, headAngleY, headAngleX, p_78088_7_, entitymoth);
   ...
   @Override
   public void setRotationAngles(float time, float swingSuppress, float par3, float headAngleY, float headAngleX, float par6, Entity entitymoth)
   {
       // animate if moving        
       updateDistanceMovedTotal(entitymoth);
       
       cycleIndex = (int) ((getDistanceMovedTotal(entitymoth)*CYCLES_PER_BLOCK) %flappingCycle.length);
